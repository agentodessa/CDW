...
gulp.task('watch', ['clean'], function () {
    ...
    gulp.watch(appDir + assetsDir + '*.css', ['css']);
...
gulp.task('dev', ['clean'], function () {
    gulp.start('scripts.app', 'scripts.vendor', 'css',
        'templates.direct', 'server', 'watch', 'fonts', 'images', 'config');
    gutil.log('tasks is completed');
});

gulp.task('build', ['clean'], function () {
    gulp.start('scripts.app', 'scripts.vendor', 'css', 'templates.direct', 'fonts', 'images', 'config');
    gutil.log('tasks is completed');
});
